...
-----------------------------------------------------------------------------------------------------------------------
 Operator Notes:
 1. It takes this code approximately 03:02:xx (hh:mm:45) to execute on my laptop running SQL Server 2017 
    Developer's Edition.
...
--===== Best Practice w/Fill Factor = 100
   ...
   EXEC dbo.PopulateGuidTestAdaptive_FragTest10
         @pTestName         = 'BPDD_FF100'   --DELETE FROM dbo.IxPageStats WHERE TestName LIKE 'BPDD_FF%'
        ,@pTestDays         = @TestDays     
...
;
-----------------------------------------------------------------------------------------------------------------------
--===== Best Practice w/Fill Factor = 80 (35:18)
        CHECKPOINT;
   DBCC FREEPROCCACHE;
   EXEC dbo.PopulateGuidTestAdaptive_FragTest10
