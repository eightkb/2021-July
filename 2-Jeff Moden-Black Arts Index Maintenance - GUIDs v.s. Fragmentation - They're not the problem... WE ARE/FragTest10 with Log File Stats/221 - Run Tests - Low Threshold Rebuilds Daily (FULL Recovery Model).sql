...
-----------------------------------------------------------------------------------------------------------------------
 Operator Notes:
 1. It takes this code approximately 00:35:09 (hh:mm:02) to execute on my laptop running SQL Server 2008 
    Developer's Edition.
...
--===== Rename the table to keep it for later experiments
     IF OBJECT_ID('dbo.LTDDFull_FF090','U') IS NOT NULL
        DROP TABLE dbo.LTDDFull_FF090
;
   EXEC sp_rename 'dbo.GuidTest','LTDDFull_FF090'
;
-----------------------------------------------------------------------------------------------------------------------
...
;
--===== Rename the table to keep it for later experiments
     IF OBJECT_ID('dbo.LTDDFull_FF080','U') IS NOT NULL
        DROP TABLE dbo.LTDDFull_FF080
;
   EXEC sp_rename 'dbo.GuidTest','LTDDFull_FF080'
;
-----------------------------------------------------------------------------------------------------------------------
...
;
--===== Rename the table to keep it for later experiments
     IF OBJECT_ID('dbo.LTDDFull_FF070','U') IS NOT NULL
        DROP TABLE dbo.LTDDFull_FF070
;
   EXEC sp_rename 'dbo.GuidTest','LTDDFull_FF070'
;
-----------------------------------------------------------------------------------------------------------------------
--=====================================================================================================================
